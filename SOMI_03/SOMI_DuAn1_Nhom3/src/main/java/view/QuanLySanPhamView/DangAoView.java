...
import serviceimpl.QuanLySanPhamServiceImpl.ViewDangAoServiceImpl;
...
public class DangAoView extends javax.swing.JFrame {
    ...
    private ViewDangAoService service = new ViewDangAoServiceImpl();
    
    public DangAoView() {
        initComponents();
    }

    public void loadData(List<DangAo> chatLieu){
        defaultTableModel = (DefaultTableModel) tblDangAo.getModel();
        defaultTableModel.setRowCount(0);
        for(DangAo x: chatLieu){
