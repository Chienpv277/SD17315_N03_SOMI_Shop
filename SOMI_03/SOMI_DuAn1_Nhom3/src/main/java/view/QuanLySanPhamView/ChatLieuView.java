...
public class ChatLieuView extends javax.swing.JFrame {
    ...
    private ViewChatLieuService service = new ViewChatLieuServiceImpl();
    
    public ChatLieuView() {
        initComponents();
    }

    public void loadData(List<ChatLieu> chatLieu){
        defaultTableModel = (DefaultTableModel) tblChatLieu.getModel();
        defaultTableModel.setRowCount(0);
        for(ChatLieu x: chatLieu){
            defaultTableModel.addRow(new Object[]{
                x.getId_chat_lieu(), x.getMa(), x.getTen()
            });
        }
    }
