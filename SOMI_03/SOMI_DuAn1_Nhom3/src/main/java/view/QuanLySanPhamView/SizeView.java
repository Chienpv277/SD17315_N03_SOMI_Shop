...
import serviceimpl.QuanLySanPhamServiceImpl.ViewSizeServiceImpl;
...
public class SizeView extends javax.swing.JFrame {
    ...
    private ViewSizeService service = new ViewSizeServiceImpl();

    public SizeView() {
        initComponents();
    }

    public void loadData(List<Size> chatLieu) {
