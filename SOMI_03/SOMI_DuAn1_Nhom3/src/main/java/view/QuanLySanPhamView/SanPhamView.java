...
import serviceimpl.QuanLySanPhamServiceImpl.ViewSanPhamServiceImpl;
...
public class SanPhamView extends javax.swing.JFrame {
    ...
    private ViewSanPhamService service = new ViewSanPhamServiceImpl();
    
    public SanPhamView() {
        initComponents();
    }

    public void loadData(List<SanPham> chatLieu){
        defaultTableModel = (DefaultTableModel) tblSanPham.getModel();
        defaultTableModel.setRowCount(0);
        for(SanPham x: chatLieu){
