...
import serviceimpl.QuanLySanPhamServiceImpl.ViewMauSacServiceImpl;
...
public class MauSacView extends javax.swing.JFrame {
    ...
    private ViewMauSacService service = new ViewMauSacServiceImpl();
    
    public MauSacView() {
        initComponents();
    }

    public void loadData(List<MauSac> chatLieu){
        defaultTableModel = (DefaultTableModel) tblMauSac.getModel();
        defaultTableModel.setRowCount(0);
        for(MauSac x: chatLieu){
