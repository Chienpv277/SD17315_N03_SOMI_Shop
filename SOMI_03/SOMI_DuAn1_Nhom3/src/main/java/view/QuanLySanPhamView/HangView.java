...
import serviceimpl.QuanLySanPhamServiceImpl.ViewHangServiceImpl;
...
public class HangView extends javax.swing.JFrame {
    ...
    private ViewHangService service = new ViewHangServiceImpl();
            
    public HangView() {
        initComponents();
    }
    
    public void loadData(List<Hang> list){
